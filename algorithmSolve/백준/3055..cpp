...
// 1. 물이 고슴도치보다 먼저 움직여야한다.
// 2. 물과 고슴도치를 구분해야한다.

// 1번은 문제에 나와있듯이 고슴도치는 물이 이동할 다음칸을 천리안을 사용하여 그곳으로 움직이지 않는다.
// 이것을 약간 비틀어보자면 물이 먼저 이동하고 고슴도치가 이동하는 것으로 바꿀수 있다.
// 따라서 아래 풀이에서 고슴도치가 더 빨리 이동하는 것으로 순서를 바꾸면 틀린다.

// 2번은 하술하듯 물과 고슴도치의 이동기준이 다르다. 물은 굴과 돌, 물을 넘어갈수 없으나 고슴도치는
// 물과 돌, 고슴도치를 넘어갈수 없기에 if조건문이 달라진다.
